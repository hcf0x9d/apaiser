...
// With trailing slash!
define( 'SITEMAP_DIR_URL', 'http://www.apaiser.com/' );
...
$ignore = array('dynsitemap.config.php','blog/','api.php','ContactManager/index2.php','ContactManager/contact.php','ContactManager/contactsetting.php','ContactManager/index.php','ContactManager/autoresponde.php');
