...
afterLast :         callback: a callback function to execute after the last item.
*/
        ...
        this.each(function (i) {
            ...
            function transitionTo(gallery, index) {
                ...
                if ((counter >= gallery.length) || (index >= gallery.length)) {
                    ...
                    // transitioning forward from last image, execute afterLast callback
                    if (typeof config.afterLast == 'function') {
                        config.afterLast($cont);
                    }
                }
            ...
            function addControls() {
                ...
                $('.' + uniqueClass + '-controls a').each(function () {
                    if ($(this).hasClass('jshowoff-play'))
                        $(this).click(function () { isPlaying() ? pause('playBtn') : play(); return false; });
